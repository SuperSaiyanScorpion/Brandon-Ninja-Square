...
class Game:
    ...
    def show_start_screen(self):
        ...
        self.draw_text("Arrows to move, Space to jump", 22, GOLD, WIDTH / 2, HEIGHT / 2)
        self.draw_text("Press a key to play", 22, CRIMSON, WIDTH / 2, HEIGHT * 3 / 4)
    ...
    def show_go_screen(self):
        ...
        self.draw_text("GAME OVER", 48, YELLOW, WIDTH / 2, HEIGHT / 4)
        ...
        if self.score > self.highscore:
            ...
            self.draw_text("NEW HIGH SCORE!", 22, BLUE, WIDTH / 2, HEIGHT / 2 + 40)
